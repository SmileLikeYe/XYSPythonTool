...
#             countList.append(int(line))
#
#     print '从 validParm1.txt 获取参数列表成功'
#     return countList,paramList
#
#
#
# totalCount = 0
# paramListFile = codecs.open('paramList1.txt', 'wb', 'utf-8')
# with codecs.open('validParm.txt', 'rb', 'utf-8') as fr:
#     countList, paramList = getParamList(fr.readlines())
#
#     for i in xrange(len(countList)):
#         count = countList[i]
